...
public class Comptable {
  ...
  public Comptable(int ID_comptable, String nom_comptable, String prenom_comptable, String etat_comptable, int telephone_comptable, String adressemail_comptable) {
        this.ID_comptable = ID_comptable;
        this.nom_comptable = nom_comptable;
        this.prenom_comptable = prenom_comptable;
        this.etat_comptable = etat_comptable;
    ...
    public String toString() {
        return "Comptable{" + "ID_comptable=" + ID_comptable + ", nom_comptable=" + nom_comptable + ", prenom_comptable=" + prenom_comptable + ", etat_comptable=" + etat_comptable + ", telephone_comptable=" + telephone_comptable + ", adressemail_comptable=" + adressemail_comptable + '}';
    }

    public Comptable(String nom_comptable, String prenom_comptable, String etat_comptable, int telephone_comptable, String adressemail_comptable) {
        this.nom_comptable = nom_comptable;
        this.prenom_comptable = prenom_comptable;
        this.etat_comptable = etat_comptable;
        this.telephone_comptable = telephone_comptable;
