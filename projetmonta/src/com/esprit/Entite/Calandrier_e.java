...
public class Calandrier_e {
  ...
  public int getId_calandrier() {
    ...
    public Calandrier_e(int id_examen, int id_matiere, int id_salle, int id_classe, String nom, String date_ex) {
        this.id_examen = id_examen;
        this.id_matiere = id_matiere;
        this.id_salle = id_salle;
        this.id_classe = id_classe;
    ...
    public Calandrier_e(int id_calandrier, int id_examen, int id_matiere, int id_salle, int id_classe, String nom, String date_ex) {
        this.id_calandrier = id_calandrier;
        this.id_examen = id_examen;
        this.id_matiere = id_matiere;
        this.id_salle = id_salle;
