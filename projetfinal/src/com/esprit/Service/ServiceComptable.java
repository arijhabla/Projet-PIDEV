 ...
 */
   ...
   //String sql = "INSERT INTO fos_user(username) VALUES ('"+c.getUsername()+"');";
    ...
    public void update(Comptable t) throws SQLException {
          String sql ="UPDATE `esprit`.`comptable` SET `ID_comptable`='"+t.getID_comptable() + "',`nom_comptable`='"+t.getNom_comptable()+ "' ,`prenom_comptable`='"+t.getPrenom_comptable()+ "',`etat_comptable`='"+t.getEtat_comptable()+ "',`telephone_comptable`='" +t.getTelephone_comptable()+ "',`adressemail_comptable`='"+t.getAdressemail_comptable()+ "'  WHERE `ID_comptable`='"+t.getID_comptable()+"' ";
