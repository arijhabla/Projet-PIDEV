...
public class Affichier_examenController implements Initializable {
    ...
    @FXML
    private TableColumn<Examen,Timestamp> tfdate;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         tfexamen.setCellValueFactory(new PropertyValueFactory<Examen,Integer>("id_examen"));
            ...
            tfdate.setCellValueFactory(new PropertyValueFactory<Examen,Timestamp>("date_examen"));
 ...
 public void setTab(TableView<Examen> table) {
    ...
    public void setdate(TableColumn<Examen, Timestamp> date_examen) {
